...
describe('Get current weather condition', () => {
  test('It should return object is payload is defined', () => {
    const action = redWeather.fetchWeather(redWeather.fetchWeather(fetchCurrent));
...
describe('Get current weather condition', () => {
  test('It should not return undefined when payload is specified', () => {
    ...
    expect(action.payload).not.toEqual(response);
  })
});

describe('Get current weather condition', () => {
  test('It should return undefined when payload is undefined', () => {
    const action = redWeather.fetchWeather(redWeather.fetchWeather(undefined));
    const response = { type: 'weatherStore/weather/FETCH_WEATHER', payload: undefined };
    expect(action.payload).toEqual(response);
  })
});

describe('Loading weather creator', () => {
  test('It should return undefined when payload is undefined', () => {
    const action = redWeather.loadingStart(redWeather.fetchWeather(undefined));
    const response = { type: 'weatherStore/weather/FETCH_WEATHER', payload: undefined };
    expect(action.payload).toEqual(response);
  })
});
...
describe('Loading weather creator', () => {
  test('It should not return undefined when payload is specified', () => {
    ...
    const action = redWeather.loadingStart(redWeather.fetchWeather(loadStart));
    const response = { type: 'weatherStore/weather/FETCH_WEATHER', payload: undefined };
    expect(action.payload).not.toEqual(response);
  })
});
...
describe('Loading weather creator', () => {
  test('It should return object when payload is defined', () => {
    ...
    const action = redWeather.loadingStart(redWeather.fetchWeather(loadStart));
    const response = { type: 'weatherStore/weather/FETCH_WEATHER', payload: loadStart };
    expect(action.payload).toEqual(response);
  })
});
...
describe('Autocomplete Feature', () => {
  test('It should not return undefined when payload is specified', () => {
    ...
    const action = redWeather.loadingStart(redWeather.fetchWeather(location));
...
describe('Autocomplete Feature', () => {
  test('It should return object when payload is defined', () => {
    ...
    const action = redWeather.loadingStart(redWeather.fetchWeather(location));
    const response = { type: 'weatherStore/weather/FETCH_WEATHER', payload: location };
    expect(action.payload).toEqual(response);
  })
})
